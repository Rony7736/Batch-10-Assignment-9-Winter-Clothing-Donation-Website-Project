    ...
    return (
        <div className="pb-10">
            ...
            <div className="flex flex-col lg:flex-row justify-around gap-4 mx-10 mb-10">
                ...
                <div className="card bg-base-100 shadow-xl px-10 py-6  md:w-[500px] lg:h-[230px] mb-6">
                    <h2 className="text-2xl font-bold my-2 text-green-500">Steps to Donate:</h2>
                    <ul>
                ...
                <div className="card bg-base-100 shadow-xl px-10 py-6 md:w-[500px] lg:h-[230px]">
                    <h2 className="text-2xl font-bold my-2 text-green-500">Collection Points</h2>
                    <ul>
            ...
            <div className="flex flex-col lg:flex-row justify-around mx-10">
                ...
                <div className="card bg-base-100 shadow-xl px-10 py-6  md:w-[500px] lg:h-[230px] mb-6">
                    <h2 className="text-2xl font-bold my-2 text-green-500">Supported Divisions</h2>
                    <ul>
                        <li className="list-disc">Dhaka Division: [Specific Address or Landmark].</li>
                        <li className="list-disc">Chittagong Division: [Specific Address or Landmark]</li>
                        <li className="list-disc">Rajshahi Division: [Specific Address or Landmark]</li>
                ...
                <div className="card bg-base-100 shadow-xl px-10 py-6  md:w-[500px] lg:h-[230px]">
                    <h2 className="text-2xl font-bold my-2 text-green-500">Stay Updated</h2>
                    <ul>
                        <li className="list-disc">Dhaka Division: [Specific Address or Landmark].</li>
                        <li className="list-disc">Chittagong Division: [Specific Address or Landmark]</li>
                        <li className="list-disc">Rajshahi Division: [Specific Address or Landmark]</li>
